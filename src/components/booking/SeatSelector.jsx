...
// import { useState, useEffect } from "react";
// import { useSearchParams, useRouter } from "next/navigation"; // Imported useRouter for handling redirection
...
//   showtimeId: propShowtimeId,
// }) {
//   const router = useRouter(); // Initialize router hooks environment
//   const [seatsData, setSeatsData] = useState([]);
//   const [bookedSeats, setBookedSeats] = useState([]);
//   const [selectedSeats, setSelectedSeats] = useState([]);
//   const [resolvedFilmId, setResolvedFilmId] = useState(propFilmId || "");
...
//     // CRITICAL SECURITY CHECK: If the token doesn't exist, show error card and send to login
//     if (!token) {
//       setAuthError(
//         "Authentication Required: You must be logged in to reserve seats. Redirecting you to login page...",
//       );
//       setTimeout(() => {
//         router.push("/login"); // Triggers instant client router redirect route
//       }, 3000);
//       return;
//     }
...
//         // Handle explicit backend token validation rejections
//         setAuthError(
...
//   // Renders a stylized notification window when login is missing, blocking interaction while redirecting
//   if (authError) {
//     return (
